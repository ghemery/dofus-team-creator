...
const tierConfig: Record<Tier, { label: string; color: string; bg: string; description: string }> = {
  S: {
    ...
    description: 'Compositions légendaires — score ≥ 9',
  },
  A: {
    label: 'A',
    color: '#ff9900',
    bg: 'rgba(255, 153, 0, 0.06)',
    description: 'Très bonnes compositions — score 7-8',
  },
  B: {
    label: 'B',
    color: '#4da6ff',
    bg: 'rgba(77, 166, 255, 0.06)',
    description: 'Compositions correctes — score 5-6',
  },
  C: {
    label: 'C',
    color: '#8b949e',
    bg: 'rgba(139, 148, 158, 0.06)',
    description: 'Compositions à améliorer — score < 5',
  },
};
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          <div style={{ color: cfg.color, fontWeight: 700, fontSize: '1rem' }}>
            Tier {cfg.label}
          </div>
